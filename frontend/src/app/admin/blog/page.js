...
import { Plus, Search, Edit2, Trash2, X, Image as ImageIcon, CheckCircle, Globe, FileText } from "lucide-react";
              ...
              <form onSubmit={handleSave} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-4">
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-1 ml-1">Tiêu đề bài viết</label>
                    ...
                    <div>
                      ...
                      <input type="text" value={formData.slug} onChange={e => setFormData({ ...formData, slug: e.target.value })} placeholder="VD: bai-viet-so-1"
                    ...
                    <div>
                      <label className="block text-sm font-bold text-gray-700 mb-1 ml-1">Đoạn trích (Excerpt)</label>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1 ml-1">Nội dung bài viết (Hỗ trợ thẻ HTML cơ bản)</label>
                  <textarea required rows="15" value={formData.content} onChange={e => setFormData({ ...formData, content: e.target.value })}
                    placeholder="<h1>Tiêu đề chính</h1><p>Nội dung đoạn văn bản...</p>"
                    className="w-full glass-panel border border-white/60 rounded-2xl px-4 py-4 text-idaz-black text-sm focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all shadow-inner font-mono bg-white/50" />
                </div>
